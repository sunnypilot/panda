...
def setup_safety_helpers(ffi):
  ...
  void set_mads_params(bool enable_mads, bool disengage_lat_on_brake, bool main_cruise_allowed, bool always_allow_mads_button);
  """)
...
class PandaSafety(Protocol):
  ...
  def get_main_cruise_allowed(self) -> bool: ...
  def get_always_allow_mads_button(self) -> bool: ...
  ...
  def set_mads_params(self, enable_mads: bool, disengage_lat_on_brake: bool, main_cruise_allowed: bool,
                      always_allow_mads_button: bool) -> None: ...

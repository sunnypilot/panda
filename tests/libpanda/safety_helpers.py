...
def setup_safety_helpers(ffi):
  ...
  void set_main_button_prev(int main_button_prev);
  void set_lkas_button_prev(int lkas_button_prev);
...
class PandaSafety(Protocol):
  ...
  def get_main_button_prev(self) -> int: ...
  ...
  def set_main_button_prev(self, main_button_prev: int) -> None: ...
  def set_lkas_button_prev(self, lkas_button_prev: int) -> None: ...
